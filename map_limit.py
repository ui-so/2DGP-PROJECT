...
MAP_LIMITS = {
    ...
    'spawn_2': (1925, 890, 300, 230, 2100, 800, 3025, 990),
    'prairie_1': (3670, 860, 890, 520, 2100, 800, 3025, 990),
    'prairie_2': (3670, 860, 890, 520, 3560, 1260, 3760, 2300),
    'lava_1': (3650, 2570, 900, 500, 3560, 1260, 3760, 2300),
    'lava_2': (3650, 2570, 900, 500, 2100, 2450, 3025, 2550),
    'lava_3': (3650, 2570, 900, 500, 3460, 2960, 3660, 3650),
    'ice_1': (1200, 2500, 900, 520, 2100, 2450, 3025, 2550),
    'cave_1': (3500, 4080, 1000, 500, 3460, 2960, 3660, 3650),
    'cave_2': (3500, 4080, 1000, 500, 1800, 3950, 3025, 4150),
    'end_1': (1100, 4050, 800, 420, 1800, 3950, 3025, 4150),
}
